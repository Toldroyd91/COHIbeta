document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('.canvas-group').forEach(group => {
        ...
        function bindLineTool() {
            ...
            fCanvas.on('mouse:down', function(o) {
                ...
                activeLineObj = new fabric.Line([startX, startY, startX, startY], { strokeWidth: 4 / z, stroke: '#FF3B30', originX: 'center', originY: 'center', selectable: false, hasControls: false });
        ...
        function bindDimLineTool() {
            ...
            fCanvas.on('mouse:down', function(o) {
                ...
                activeLineObj = new fabric.Line([startX, startY, startX, startY], { strokeWidth: 3 / z, stroke: '#00E5FF', strokeDashArray: [5 / z, 5 / z], originX: 'center', originY: 'center', selectable: false, hasControls: false });
                fCanvas.add(activeLineObj);
            });
            fCanvas.on('mouse:move', function(o) {
        ...
        function bindTextTool() {
            ...
            fCanvas.on('mouse:down', function(o) {
                ...
                const mmText = new fabric.IText('Text', {
                    left: pointer.x, top: pointer.y, fontFamily: 'Inter', fontSize: 20 / z, fill: '#00E5FF', fontWeight: 'bold', backgroundColor: 'rgba(0,0,0,0.8)', padding: 6 / z, cornerSize: 8 / z, transparentCorners: false, hasControls: true
                });
                fCanvas.add(mmText);
    ...
    // --- 5. SECURE LOGO & IMAGE CONVERTERS ---
        ...
        return new Promise((resolve) => {
            ...
            img.onload = function() {
                try {
                    ...
                    console.error("CORS Error on Pamphlet: " + url);
                    resolve(null);
                }
            };
    ...
    async function executeSecurePDFGeneration(templateId, fileName, btn, data) {
        ...
        mainApp.style.display = 'none'; // Stable memory fix
    ...
    // --- 8. EVENT LISTENERS FOR PDF GENERATION ---
